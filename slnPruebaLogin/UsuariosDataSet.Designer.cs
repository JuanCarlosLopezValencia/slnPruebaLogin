...
namespace slnPruebaLogin {
    ...
    public partial class UsuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class tblUsuarioDataTable : global::System.Data.TypedTableBase<tblUsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public tblUsuarioRow AddtblUsuarioRow(int IdUsuario, string Usuario, string Clave, int rol) {
        ...
        public partial class tblUsuarioRow : global::System.Data.DataRow {
            ...
            public string Clave {
                get {
                    return ((string)(this[this.tabletblUsuario.ClaveColumn]));
                }
                set {
                    this[this.tabletblUsuario.ClaveColumn] = value;
                }
            }
            ...
            public int rol {
                get {
                    return ((int)(this[this.tabletblUsuario.rolColumn]));
                }
                set {
...
namespace slnPruebaLogin.UsuariosDataSetTableAdapters {
    ...
    public partial class tblUsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblUsuario] WHERE (([IdUsuario] = @Original_IdUsuario) AND ([U" +
                "suario] = @Original_Usuario) AND ([Clave] = @Original_Clave) AND ([rol] = @Origi" +
                "nal_rol))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblUsuario] ([IdUsuario], [Usuario], [Clave], [rol]) VALUES (@" +
                "IdUsuario, @Usuario, @Clave, @rol);\r\nSELECT IdUsuario, Usuario, Clave, rol FROM " +
                "tblUsuario WHERE (IdUsuario = @IdUsuario)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblUsuario] SET [IdUsuario] = @IdUsuario, [Usuario] = @Usuario, [Clave] = @Clave, [rol] = @rol WHERE (([IdUsuario] = @Original_IdUsuario) AND ([Usuario] = @Original_Usuario) AND ([Clave] = @Original_Clave) AND ([rol] = @Original_rol));
SELECT IdUsuario, Usuario, Clave, rol FROM tblUsuario WHERE (IdUsuario = @IdUsuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::slnPruebaLogin.Properties.Settings.Default.UsuariosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdUsuario, Usuario, Clave, rol FROM dbo.tblUsuario";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT IdUsuario, Usuario, Clave, rol FROM dbo.tblUsuario\r\n";
        ...
        public virtual int Fill(UsuariosDataSet.tblUsuarioDataTable dataTable) {
        ...
        public virtual UsuariosDataSet.tblUsuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UsuariosDataSet.tblUsuarioDataTable dataTable = new UsuariosDataSet.tblUsuarioDataTable();
        ...
        public virtual int FillBy(UsuariosDataSet.tblUsuarioDataTable dataTable) {
        ...
        public virtual UsuariosDataSet.tblUsuarioDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            UsuariosDataSet.tblUsuarioDataTable dataTable = new UsuariosDataSet.tblUsuarioDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UsuariosDataSet.tblUsuarioDataTable dataTable) {
        ...
        public virtual int Delete(int Original_IdUsuario, string Original_Usuario, string Original_Clave, int Original_rol) {
        ...
        public virtual int Insert(int IdUsuario, string Usuario, string Clave, int rol) {
        ...
        public virtual int Update(int IdUsuario, string Usuario, string Clave, int rol, int Original_IdUsuario, string Original_Usuario, string Original_Clave, int Original_rol) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Usuario, string Clave, int rol, int Original_IdUsuario, string Original_Usuario, string Original_Clave, int Original_rol) {
            return this.Update(Original_IdUsuario, Usuario, Clave, rol, Original_IdUsuario, Original_Usuario, Original_Clave, Original_rol);
        }
    }
